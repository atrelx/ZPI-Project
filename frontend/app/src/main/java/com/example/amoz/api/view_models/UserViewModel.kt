...
class UserViewModel @Inject constructor(
    ...
    private val _registerUserState = MutableLiveData<ResultState<User>>()
    val registerUserState: LiveData<ResultState<User>> = _registerUserState

    private val _updateUserState = MutableLiveData<ResultState<User>>()
    val updateUserState: LiveData<ResultState<User>> = _updateUserState
