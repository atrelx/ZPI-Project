...
data class CompanyScreenUIState (
    ...
    val companyB2BCustomers: MutableStateFlow<ResultState<MutableList<CustomerB2B>>> = MutableStateFlow(
        ResultState.Idle
    ),
    val companyB2CCustomers: MutableStateFlow<ResultState<MutableList<CustomerB2C>>> = MutableStateFlow(
        ResultState.Idle
    ),
