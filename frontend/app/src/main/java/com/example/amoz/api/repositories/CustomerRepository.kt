...
class CustomerRepository @Inject constructor(
    ...
    suspend fun createCustomerB2B(request: CustomerB2BCreateRequest): com.example.amoz.models.CustomerB2B? {
        return performRequest {
            customerService.createCustomerB2B(request)
        }
    }

    suspend fun createCustomerB2C(request: CustomerB2CCreateRequest): com.example.amoz.models.CustomerB2C? {
        return performRequest {
            customerService.createCustomerB2C(request)
        }
    }

    suspend fun updateCustomerB2B(customerId: UUID, request: CustomerB2BCreateRequest): com.example.amoz.models.CustomerB2B? {
        return performRequest {
            customerService.updateCustomerB2B(customerId, request)
        }
    }

    suspend fun updateCustomerB2C(customerId: UUID, request: CustomerB2CCreateRequest): com.example.amoz.models.CustomerB2C? {
        return performRequest {
            customerService.updateCustomerB2C(customerId, request)
        }
    }

    suspend fun getAllCustomersB2B(): List<com.example.amoz.models.CustomerB2B> {
        return performRequest {
            customerService.getAllCustomersB2B()
        } ?: listOf()
    }

    suspend fun getAllCustomersB2C(): List<com.example.amoz.models.CustomerB2C> {
        return performRequest {
